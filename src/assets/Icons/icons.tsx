export const QuestionIcon = () => {
    return <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="bi:question-circle-fill" clip-path="url(#clip0_7_1572)">
            <g id="Group">
                <path id="Vector"
...
export const ChartIcon = () => {
    return <svg width="40" height="36" viewBox="0 0 40 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Chart_duotone_line">
            <rect id="Rectangle 25" x="4.93549" y="6" width="29.6129" height="24" rx="2" fill="black"
                  fill-opacity="0.49"/>
            <path id="Vector 8" d="M13.1613 15L13.1613 24" stroke="white" stroke-width="1.2" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path id="Vector 9" d="M19.7419 18V24" stroke="white" stroke-width="1.2" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path id="Vector 10" d="M26.3226 12V24" stroke="white" stroke-width="1.2" stroke-linecap="round"
                  stroke-linejoin="round"/>
        </g>
    </svg>
